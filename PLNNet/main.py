...
class GuidedFilter(nn.Module):
    ...
    def __init__(
        ...
        self._b = nn.Parameter(
            torch.Tensor(1, H, W), requires_grad=a_b_learnable
            )
    ...
    def create_mean_filter(channels, kernel_sym_size):
        fil = nn.Conv2d(
            channels,channels,(kernel_sym_size, kernel_sym_size),groups=channels,bias=False,padding=kernel_sym_size // 2,
            )
        # requires_grad_：
    ...
    def _compute_a_b_loss(self, im_p, im_I):
        ...
        loss = ( b_sq + a_sq * (eps + corr_II) + 2 * a * b * mean_I
            - 2 * a * corr_Ip - 2 * b * mean_p + corr_pp)
...
if __name__ == "__main__":
    ...
    guide = Image.open("C:/Users/ASUS/Desktop/Learnable/data/Guide.jpg").convert('L')
    depth = Image.open("C:/Users/ASUS/Desktop/Learnable/data/boxes.jpg").convert('L')
    gt_depth = Image.open("C:/Users/ASUS/Desktop/Learnable/data/GT.jpg").convert('L')
    ...
    if depth is not None:
        ...
        depth, mu_depth, s = normalize(depth)
